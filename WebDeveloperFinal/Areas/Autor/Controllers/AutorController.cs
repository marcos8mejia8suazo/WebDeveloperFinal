...
using WebDeveloperFinal.Models;

namespace WebDeveloperFinal.Areas.Autor.Controllers
{
    [Authorize(Roles = "Admin")]

    public class AutorController : BaseAccountController
    {
        ...
        [HttpPost]
        public ActionResult NuevoAutor(RegisterViewModel model)
        {
            var user = new WebDeveloperAutor { UserName = model.Email, Email = model.Email };
